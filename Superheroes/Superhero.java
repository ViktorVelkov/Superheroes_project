...
public class Superhero {
	...
	public Superhero( String name ) {
		...
		// Neat alternative: this(name, 10);, but this is not expected
	...
	public void powerUp( int strengthIncrease ) {
		...
		// Important that this INCREMENTS the strength and does not replace it.
	 ...
	 * 
	 * Demonstrates the concept of referring to a class type inside that class 
	 * itself, and that a class type can be used anywhere a normal variable type is used.
	 * 
